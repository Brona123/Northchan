...
import "./index.html";
import "/imports/ui/components/thread-container.js";
import "/imports/ui/components/form-components/file.js";
...
Template.index.onCreated(function() {
	...
	tpl.autorun(function() {
		...
		tpl.subscribe("sections", sectionMatcher, sectionOptions, (callback) => {

			const sectionIds = Sections.find().fetch().map((section) => { return section._id; });
			const threadMatcher = {sectionId : {$in : sectionIds}};
			const threadOptions = {
				sort : {"currentlyViewing" : -1, "sortableTime" : -1},
				limit : Session.get("sectionLimit") * 6
			};
